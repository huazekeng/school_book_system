  ...
  <div class="container" style="padding-top:5px;">
    <Form ref="formInline"  inline>
      <FormItem prop="borrowRecord">
        <Input type="text" v-model="formInline.query" placeholder="订单编号">
...
<script type="es6">
  export default {
    ...
    methods: {
      ...
      request (currentPage){
         this.$axios.get(`/api/order/${this.currPage}/${this.pageSize}`, {params: { query: this.formInline.query }}).then(res=>{
